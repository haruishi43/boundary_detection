...
# FIXME: this module is not used
class MultiEvalModule(DataParallel):
    """Multi-size Segmentation Eavluator"""

    def __init__(self, module, nclass, device_ids=None, flip=True, multi_scales=False):
        ...
        self.flip = flip
        print("MultiEvalModule: crop_size {}".format(self.crop_size))
