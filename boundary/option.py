...
class Options:
    def __init__(self):
        ...
        # model and dataset
        parser.add_argument(
            "--model", type=str, default="dff", help="model name (default: dff)"
        )
        parser.add_argument(
            "--backbone",
            type=str,
        ...
        parser.add_argument(  # FIXME: unused
            "--data-folder",
            type=str,
            default=("./data"),
            help="training dataset folder (default: ./data)",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--crop-size", type=int, default=512, help="crop image size"
        )
        ...
        parser.add_argument(
            "--checkname", type=str, default="default", help="set the checkpoint name"
        )
        parser.add_argument(
